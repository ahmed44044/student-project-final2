...
router.post('/Scientific',auth(endPoint.add),adminController.addScientificReference)
...
router.post('/addCoursesLev1',validation(validators.Course),auth(endPoint.add),adminController.addCourse1)
router.post('/addCoursesLev2',validation(validators.Course),auth(endPoint.add),adminController.addCourse2)
router.post('/addCoursesLev3',validation(validators.Course),auth(endPoint.add),adminController.addCourse3)
router.post('/addCoursesLev4',validation(validators.Course),auth(endPoint.add),adminController.addCourse4)
