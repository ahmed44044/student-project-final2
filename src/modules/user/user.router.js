...
router.get('/student/:id',auth(endPoint.profile),userController.students)
...
router.get('/result/:id',auth(endPoint.profile),userController.showResult)
router.get('/Reference',auth(endPoint.profile),userController.ShowReference)
